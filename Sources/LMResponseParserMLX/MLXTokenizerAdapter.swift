...
/// Bridges `any MLXLMCommon.Tokenizer` to `any ParserTokenizer`.
///
/// `ParserTokenizer`'s three method signatures match `MLXLMCommon.Tokenizer`'s
/// exactly, but Swift cannot pass `any MLXLMCommon.Tokenizer` where
/// `any ParserTokenizer` is expected: protocol-existential-to-protocol-existential
...
struct MLXTokenizerAdapter: ParserTokenizer {
