...
/// ``/LMResponses/ResponseFormat/infer(modelName:modelType:modelConfig:)``.
///
...
public final class ResponseChatSession {
  ...
  /// The terminal ``/LMResponses/Response`` snapshot from the most
  ...
  /// type: receives a Responses-native ``/LMResponses/ResponseFunctionToolCall`` with
  ...
  /// ``/LMResponses/ResponseFunctionCallOutput/Output/string(_:)``;
  /// return typed text, image, or file parts as
  /// ``/LMResponses/ResponseFunctionCallOutput/Output/content(_:)``.
  ...
  /// completion and returns the ``/LMResponses/Response`` carried by
